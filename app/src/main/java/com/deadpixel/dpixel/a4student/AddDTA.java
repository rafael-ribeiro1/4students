...
public class AddDTA extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dta);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(AddDTA.this);
        ...
        if (select_user.getTipo().equals("prof")) {
                ...
                public void onClick(View v) {
                    if (String.valueOf(TedtNome.getText()).trim().equals("") || String.valueOf(TedtCod.getText()).trim().equals("")) {
                        ...
                        if (db.verificarNExiTCod(TedtCod.getText().toString())) {
                            ...
                            Intent intentAddA = new Intent(AddDTA.this, AddAlunosA.class);
            ...
            TbtnUsarCA.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (select_user.getNca() == 0) {
                        Toast.makeText(AddDTA.this, getString(R.string.nao_tem_ca), Toast.LENGTH_LONG).show();
                    } else {
            ...
            TbtnCriarCA.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog.showDialog(AddDTA.this, 2, 0, 0);
                }
            });
                ...
                public void onClick(View v) {
                    if (String.valueOf(TedtNome.getText()).trim().equals("") || String.valueOf(TedtCod.getText()).trim().equals("")) {
                        ...
                        if (db.verificarNExiTCod(TedtCod.getText().toString())) {
                            ...
                            Intent intentTAdd = new Intent(AddDTA.this, Avaliacao.class);
                ...
                public void onClick(View v) {
                    if (String.valueOf(DedtNome.getText()).trim().equals("") || String.valueOf(DedtCod.getText()).trim().equals("")) {
                        ...
                        if (db.verificarNExiDCod(DedtCod.getText().toString())) {
                            ...
                            Intent intentDAdd = new Intent(AddDTA.this, Avaliacao.class);
