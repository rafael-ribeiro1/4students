...
public class AddCAAE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_caae);
        ...
        id = getIntent().getIntExtra("DTID", 0);
        ...
        // Botão para Criar os Critérios de Avaliação e voltar à página de edição de Disciplina/Turma
            ...
            public void onClick(View v) {
                ...
                if (criterioAvaliacao2.getCanpara() == 0) {
                    ...
                    if (tcot != 100) {
                        ...
                        Intent intent = new Intent(AddCAAE.this, EditDT.class);
        ...
        listCA.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog.showDialog(AddCAAE.this, position, temp.getDti2());
            }
        });
    ...
    public void listPara() {
        ...
        adapter = new ArrayAdapter<String>(AddCAAE.this, android.R.layout.simple_list_item_1, arrayList);
