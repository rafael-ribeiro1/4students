...
public class EditAlunos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_alunos);
        ...
        btnAva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentAva;if (ny == 0 || ny == 1) {
                    intentAva = new Intent(EditAlunos.this, Registo3.class);
                    intentAva.putExtra("NY", ny);
                } else {
                    intentAva = new Intent(EditAlunos.this, Avaliacao.class);
                }
        ...
        btnAddAlu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.showDialog(EditAlunos.this, select_temp.getDts1());
            }
        });
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtAluS.getText().toString().equals("Nenhum") || txtAluS.getText().toString().equals("None")) {
                    ...
                    AddAlunoDialog dialog = new AddAlunoDialog();
                    dialog.showDialogEdit(EditAlunos.this, select_temp.getDts1(), num_al_sele, aluno.getAnome());
                }
            }
        });
    ...
    public void listAluno() {
        ...
        adapter = new ArrayAdapter<String>(EditAlunos.this, android.R.layout.simple_list_item_1, arrayList);
