...
public class AddAlunosA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_alunosa);
        ...
        btnAva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentAva = new Intent(AddAlunosA.this, Avaliacao.class);
        ...
        btnAddAlu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.showDialog(AddAlunosA.this, select_temp.getDts1());
            }
        });
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtAluS.getText().toString().equals("Nenhum") || txtAluS.getText().toString().equals("None")) {
                    ...
                    AddAlunoDialog dialog = new AddAlunoDialog();
                    dialog.showDialogEdit(AddAlunosA.this, select_temp.getDts1(), num_al_sele, aluno.getAnome());
                }
            }
        });
    ...
    public void listAluno() {
        ...
        adapter = new ArrayAdapter<String>(AddAlunosA.this, android.R.layout.simple_list_item_1, arrayList);
