...
public class AddCA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (criterioAvaliacao2.getCanpara() == 0) {
                    ...
                    if (tcot != 100) {
                        ...
                        Intent intent = new Intent(AddCA.this, AddDT.class);
                        if (ny == 0) {
        ...
        listCA.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog.showDialog(AddCA.this, position, temp.getDti2());
            }
        });
    ...
    public void listPara() {
        ...
        adapter = new ArrayAdapter<String>(AddCA.this, android.R.layout.simple_list_item_1, arrayList);
